            ...
            <div className="shortcut-list">
                {!client &&
                    <Link to={'/iniciar-sesion'} className="shortcut">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="64" color="#000000" fill="none">
                ...
                }
                {
                    ...
                    <div className="shortcut" onClick={() => setChangeAddress(true)}>
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="42" color="#000000" fill="none">
                ...
                <div className="shortcut" onClick={() => setSeeBenefit(true)}>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="54" color="#000000" fill="none">
